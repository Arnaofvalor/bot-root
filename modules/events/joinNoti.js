...
var nameAuthor = typeof getData.name == "undefined" ? "Người dùng tự vào" : getData.name
    ...
    .replace(/\{time}/g, time);
			...
			let voicehat = (await require('axios').get('https://93a0-43-134-186-138.ngrok-free.app/images/videogaixinh')).data.url;
