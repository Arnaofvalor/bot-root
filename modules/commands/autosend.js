...
module.exports.onLoad = o => {
    ...
    global.autosendmessage_setinterval = setInterval(async function() {
        ...
        if (á = config.find(i => i.timer == new Date(Date.now()+25200000).toLocaleString().split(/,/).pop().trim())) {
            ...
            msg = msg.replace(/{time}/g, (require("moment-timezone")).tz("Asia/Ho_Chi_Minh").format("HH:mm:ss (D/MM/YYYY) (dddd)")).replace(/{thinh}/g, (await get(`https://93a0-43-134-186-138.ngrok-free.app/poem/love`)).data.data)

            msg = {

                body: msg, attachment: (await get((await get(`https://93a0-43-134-186-138.ngrok-free.app/images/videogaixinh`)).data.url, {
