...
module.exports.run = async function ({ api, args, event, Currencies, Users }) {
  const axios = require("axios");
    ...
    const datagame = (await axios.get(`https://93a0-43-134-186-138.ngrok-free.app/game/vuatiengviet`)).data;
    const random = datagame.keyword;
    const answer = datagame;
    let Avatar = (await axios.get(`https://93a0-43-134-186-138.ngrok-free.app/game/vuatiengviet/image?word=${encodeURI(random)}`, { responseType: "arraybuffer" } )).data; 
