 ...
 const timeNow = moment.tz("Asia/Ho_Chi_Minh").format("HH:mm:ss - DD/MM/YYYY");
  ...
  const {
    ...
    if (type) {
        ...
        api.sendMessage({body: msg1 + msg, attachment: (await require('axios').get(`https://i.imgur.com/Oowm6KX.jpeg`, {
        responseType: 'stream'
    })).data
